...
def _load_query_set_mapping(path: str) -> dict[str, list[str]]:
...
def main() -> None:
    ...
    if not runs:
        st.error(
            ...
            f"Expected `*_requests.csv` generated by batch tests."
        )
        return
    ...
    query_set_mapping = _load_query_set_mapping(str(QUERY_SETS_PATH))
